...
TEST_CASE("Boolean without implicit value", "[implicit]") {
  ...
  options.add_options()("bool", "Boolean without implicit",
...
TEST_CASE("Default values", "[default]") {
  ...
  options.add_options()("default", "Has implicit",
      ...
      "v,vector", "Default vector",
      cxxopts::value<std::vector<int>>()->default_value("1,4"));
...
TEST_CASE("std::vector", "[vector]") {
  ...
  options.add_options()("vector", "an vector option",
